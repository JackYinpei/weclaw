...
// UserSkill is a container's enabled skill with optional config overrides.
type UserSkill struct {
	ID          uint           `gorm:"primarykey" json:"id"`
	ContainerID uint           `gorm:"uniqueIndex:idx_container_skill;not null" json:"container_id"`
	SkillName   string         `gorm:"uniqueIndex:idx_container_skill;size:128;not null" json:"skill_name"`
...
// UserMCP is a container's enabled MCP server with env overrides.
type UserMCP struct {
	ID          uint           `gorm:"primarykey" json:"id"`
	ContainerID uint           `gorm:"uniqueIndex:idx_container_mcp;not null" json:"container_id"`
	MCPName     string         `gorm:"uniqueIndex:idx_container_mcp;size:128;not null" json:"mcp_name"`
	Enabled     bool           `gorm:"default:true" json:"enabled"`
